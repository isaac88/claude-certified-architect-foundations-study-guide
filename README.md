...
Unofficial preparation notes for Anthropic's **Claude Certified Architect (Foundations)** exam (CCA-F) — a complete study path one candidate built and the next can fork. 🎓 Fork it, blank the tracker, make it your own journey: [docs/getting-started.md](docs/getting-started.md).
...
| ✍️ 4. Prompt Engineering & Structured Output | 20% | [domains/04-prompt-engineering](domains/04-prompt-engineering/) |
