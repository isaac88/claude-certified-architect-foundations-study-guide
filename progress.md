...
Timed full-length mock scores (no official practice exam exists — corrected 21 Sep 2026): site 1 **900/1000** (17 Sep) · site 2: ____  
Exam date: ________
...
- [ ] 29. Second full-length timed mock, different source (e.g. [certificationpractice.com](https://certificationpractice.com/practice-exams/anthropic-claude-certified-architect-foundations)) — first full mock was 900/1000 on claudecertificationguide.com, 17 Sep. **Corrected 21 Sep 2026: the "official Academy practice exam" this step originally named does not exist** (the student checked the Academy page; web check agreed — every CCA-F practice exam is third-party; see [docs/academy-courses.md](docs/academy-courses.md)). Two independent full-length passes with disputed keys checked against vendor docs → book Pearson VUE
