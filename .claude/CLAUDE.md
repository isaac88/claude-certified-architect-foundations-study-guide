...
- One commit per working exercise, message `Add <where> exercise NN: <what it is>` or `Pass step NN: <what>`; anything else (fixes, logs, tooling) uses `<Area>: <what changed>`. Push after each.
