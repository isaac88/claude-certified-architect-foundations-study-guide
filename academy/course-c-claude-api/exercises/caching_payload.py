"""Course scaffolding for exercise 36 (prompt caching) — VERBATIM from the
official 003_caching.ipynb, cells 2 and 3: the ~6k-token code-generator
system prompt and the ~1.7k-token tool schemas that make caching worth
measuring. Not our code; kept unedited so the exercise measures what the
course measures. See 36-prompt-caching.py for the exercise itself."""
