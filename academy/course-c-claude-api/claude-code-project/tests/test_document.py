...
class TestDocumentPathToMarkdown:
    ...
    def test_document_path_to_markdown_with_docx(self):
        """Test converting a DOCX document by path."""
    ...
    def test_document_path_to_markdown_with_pdf(self):
        """Test converting a PDF document by path."""
    ...
    def test_document_path_to_markdown_missing_file(self):
        """A path that does not exist must raise, not return empty output."""
        with pytest.raises(FileNotFoundError):
            document_path_to_markdown(os.path.join(self.FIXTURES_DIR, "no_such.docx"))
